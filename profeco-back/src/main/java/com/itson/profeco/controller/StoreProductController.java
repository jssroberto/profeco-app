...
public class StoreProductController {
    ...
    @Operation(summary = "Get all store products", description = "Retrieves all store products. Accessible only by customers.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved all store products"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden - User does not have the required role (CUSTOMER)")
    })
    @GetMapping
    ...
    @Operation(summary = "Get store product by ID", description = "Retrieves a store product by its ID. Returns base product details.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved store product", content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoreProductResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    @Operation(summary = "Find store products without offers by store ID", description = "Retrieves products for a store that don't have an offer price.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Find store products without offers by store name", description = "Retrieves products by store name that don't have an offer price.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Find store products without offers by product name", description = "Retrieves products by product name across all stores that don't have an offer price.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved products without offers"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden - User does not have required role")
    ...
    @Operation(summary = "Find store products without offers by base price range", description = "Retrieves products without offers within a specified base price range.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved products without offers"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden - User does not have required role")
    ...
    @Operation(summary = "Find specific store product without offer by store and product IDs", description = "Retrieves a specific product for a store, if it doesn't have an offer price.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved store product without offer", content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoreProductResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden - User does not have required role"),
    ...
    @Operation(summary = "Find store products without offers by store, ordered by price", description = "Retrieves products for a store (no offers) ordered by base price.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved products without offers"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden - User does not have required role")
    ...
    @Operation(summary = "Create store product", description = "Adds a new product to a store with its base price.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Store product created successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoreProductResponse.class))),
    ...
    @Operation(summary = "Update store product by Product ID in current store", description = "Updates a store product's price, identified by product ID and the admin's store.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Store product updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = StoreProductResponse.class))),
