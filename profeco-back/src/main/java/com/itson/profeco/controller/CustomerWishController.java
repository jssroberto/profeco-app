...
public class CustomerWishController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Wish created successfully", headers = @io.swagger.v3.oas.annotations.headers.Header(name = "Location", description = "URL of the newly created wish")),
    ...
    public ResponseEntity<WishResponse> createCustomerWish(
        ...
        URI location = ServletUriComponentsBuilder
                .fromCurrentRequest()
                .path("/{id}")
                .buildAndExpand(savedWish.getId())
                .toUri();
