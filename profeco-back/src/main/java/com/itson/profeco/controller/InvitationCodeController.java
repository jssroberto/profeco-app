...
public class InvitationCodeController {
    ...
    @Operation(summary = "Check invitation code and get role", description = "Checks if an invitation code is valid and returns the associated role. It has to be 64 characters long.", tags = {
            "Invitation Codes" })
